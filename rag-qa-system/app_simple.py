...
multi_benchmark_model = api.model('MultiBenchmarkRequest', {
    'query': fields.String(required=True, description='질문 내용'),
    'summarize': fields.Boolean(default=False, description='요약 여부'),
    'local_model': fields.String(default='./models/kanana8b', description='로컬 LLM 모델')
})
